Ext.define('Dashboard.view.deal.api.DealRequestGroupDialog', {
    extend: 'Ext.Dialog',
            ...
            items: [
                {
                    ...
                    listeners: {
                        childdoubletap: function (me, location) {
                            ExtUtil.mask('apiDealRequestGroupDialog', 'Обновление группы')
                            let rec = me.getStore().getAt(location.recordIndex)
                            ExtUtil.mRequest({
                                url: '/deal/api/updateApiDealRequestGroup',
                                params: {
                                    pid: rec.get('pid')
                                },
                                loadingComponentRef: 'apiDealRequestGroupDialog',
                                success: function (response) {
                                    ExtUtil.maskOff('apiDealRequestGroupDialog')
